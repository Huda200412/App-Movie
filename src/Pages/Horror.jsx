...
const Horror = () => {
  let data = [
    {
      src: "public/images/Horror/Dontbreath.png",
      title: "Don't Breath",
      description: "ijpjOJDVJ",
      rating: 7.0,
    },
    {
      src: "public/images/Horror/Mirage.png",
      title: "Mirage",
      description:
    ...
    {
      src: "public/images/Horror/theconjuring.png",
      title: "The Conjuring",
      description:
    ...
    {
      src: "public/images/Horror/TheNUN.png",
      title: "The NUN",
      description:
